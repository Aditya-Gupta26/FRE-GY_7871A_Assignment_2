...
- **Final forecast:** P(cut) approx. 5%, P(hold) approx. 35%, P(hike) approx. 60%, blending our model's raw output (75.5% hike, likely overconfident given a 68-meeting training set dominated by decision-momentum, not tone) with the market cross-check rather than reporting either alone.
