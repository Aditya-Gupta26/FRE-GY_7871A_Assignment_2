...
- **Final forecast:** P(cut) ≈ 5%, P(hold) ≈ 35%, P(hike) ≈ 60% — blending our model's raw output (75.5% hike, likely overconfident given a 68-meeting training set dominated by decision-momentum, not tone) with the market cross-check rather than reporting either alone.
...
docs/           STORY.md + 18 step-by-step build docs (fuller version of the story above)
